export function authorityApiUrl(path: string) {
  ...
  const localProxy: Record<string, string> = { "/world": "/api/world", "/session": "/api/session", "/attack": "/api/siege/attack", "/turn/claim": "/api/siege/turn/claim", "/defense/place": "/api/defense/place", "/identity": "/api/coronation/identity", "/recovery/create": "/api/recovery/create", "/recovery/claim": "/api/recovery/claim", "/checkout": "/api/payments/attack-checkout" };
