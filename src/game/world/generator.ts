...
function generateV010(seed: string): WorldDefinition {
  ...
  return {
    ...
    components: [
      ...
      { id: "tower:left", type: "TOWER", position: [-4.1, 2.75, -0.25], size: [1.7, 4.9, 1.7], materialClass: "STONE", maxHp: 180, destructible: true },
      { id: "tower:right", type: "TOWER", position: [4.1, 2.75, -0.25], size: [1.7, 4.9, 1.7], materialClass: "STONE", maxHp: 180, destructible: true },
      { id: "wall:front:left", type: "WALL", position: [-2.45, 1.85, 0.35 + wobble], size: [2.25, 2.75, 0.82], materialClass: "STONE", maxHp: 115, destructible: true },
      { id: "wall:front:center", type: "WALL", position: [0, 1.75, 0.38], size: [2.25, 2.55, 0.82], materialClass: "STONE", maxHp: 115, destructible: true },
      { id: "wall:front:right", type: "WALL", position: [2.45, 1.85, 0.35 - wobble], size: [2.25, 2.75, 0.82], materialClass: "STONE", maxHp: 115, destructible: true },
      { id: "gate:main", type: "GATE", position: [0, 1.15, 0.92], size: [1.8, 1.55, 0.48], materialClass: "WOOD", maxHp: 85, destructible: true },
      { id: "keep:central", type: "KEEP", position: [0, 3.2, -0.62], size: [4.2, 4.9, 1.95], materialClass: "STONE", maxHp: 220, destructible: true },
      { id: "core:enclosure", type: "CORE_ENCLOSURE", position: [0, 4.15, 0.48], size: [2.15, 1.9, 0.68], materialClass: "STONE", maxHp: 110, destructible: true },
      { id: "core:main", type: "CORE", position: [0, 4.05, 1.03], size: [0.78, 0.78, 0.78], materialClass: "CORE", maxHp: 100, destructible: true },
