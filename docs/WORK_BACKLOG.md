...
| W-086 | **Partially resolved locally:** portrait active attack composition at 390×844 is Worker-backed and viewport-bounded in `scripts/browser-attack-flow.mjs`; landscape, pointer-cancel, background/resume, checkout return, context-loss, and real iPhone/Android execution remain | I | P2 | Spec §54.5 |
