...
| W-084 | **Partially resolved locally:** real Worker/DO/D1 coverage includes duplicate defense replay, stale attack version rejection with inventory preservation, refund compensation, Durable Object eviction/reconstruction, and concurrent coronation protection; payment return loss and broader reconnect churn remain | I | P2 | Spec §54.3 |
